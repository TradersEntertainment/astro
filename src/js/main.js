...
startMotion([velocity, opening, dolly, spotlight, dust, reveals, sceneLabels, notu, ticketsMotion, tilt, wipes, masks, formats, formatsWash, certificate, marquee, finale]);
initDebug();
